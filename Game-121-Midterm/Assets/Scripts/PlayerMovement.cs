...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Walk()
    {
        ...
        _animator.SetFloat("xVelocity", 0.5f, 0.1f, Time.deltaTime);
        _animator.SetFloat("yVelocity", 0.5f, 0.1f, Time.deltaTime);
    ...
    private void Run()
    {
        ...
        _animator.SetFloat("xVelocity", 1, 0.1f, Time.deltaTime); //blending tree value of 1 equates to running animation
        _animator.SetFloat("yVelocity", 1, 0.1f, Time.deltaTime);
    }

    private void Idle() 
    {
        _animator.SetFloat("xVelocity", 0, 0.1f, Time.deltaTime); //blending tree value of 0 equates to idle animation
        _animator.SetFloat("yVelocity", 0, 0.1f, Time.deltaTime);
    }
